        ...
        <div class="nd_options_container nd_options_clearfix">
            ...
            <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_text_align_center">
                <h1 class="nd_options_color_white nd_options_font_weight_normal nd_options_first_font">
                    <span class="nd_options_display_block">PRIVACY POLICICES</span>
            ...
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner vc_custom_1467360650255">
                    <div class="wpb_wrapper">
                        ...
                        <h1 style="color:; padding:px; text-align:center; font-size:40px; line-height:50px; letter-spacing: px; font-weight:normal;" class="  nd_options_text_align_center_responsive_important nd_options_first_font ">PRIVACY POLICIES</h1>
                    </div>
                </div>
            </div>
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner vc_custom_1467207292391">
                    <div class="wpb_wrapper">
                        ...
                        <div class="wpb_text_column wpb_content_element  nd_options_text_align_center_responsive">
                            ...
                            <p><pre></pre>When you opted for our services, we collect the personal information you give us such as your name, address and email address.</p>
                            <p><pre></pre>When you submit enquiry to us, we also automatically receive your computer’s internet protocol (IP) address in order to provide us with information that helps us learn about your browser and operating system.</p>
                            <p><pre></pre>Email marketing (if applicable): With your permission, we may send you emails about our services, new products and other updates.</p>

                            <pre></pre>
                            <h2>DISCLOSURE</h2>
                            <p><pre></pre>We may disclose your personal information if we are required by law to do so or if you violate our Terms of Service.</p>
                            
                            <pre></pre>
                            <h2>SECURITY</h2>
                            <p><pre></pre>To protect your personal information, we take reasonable precautions and follow industry best practices to make sure it is not inappropriately lost, misused, accessed, disclosed, altered or destroyed.</p>
                            
                            <pre></pre>
                            <h2>COOKIES</h2>
                            <p><pre></pre>We use cookies to maintain session of your user. It is not used to personally identify you on other websites.</p>
                            
                            <pre></pre>
                            <h2>CHANGES TO THIS PRIVACY POLICY</h2>
                            
                            <p><pre></pre>Our privacy policy may change in the future, If there may be changes it will be updated on our site and a new effective date will be shown. You are advised to check the same on a regular basis to understand our current policies. However, when you do give your personal information to us the existing policy at that time would be effective. Any changes made by us in the Privacy Policy after the exchange will not be entertained in that particular situation.</p>
                            <p><pre></pre><strong>Please note: </strong><br />
