        ...
        <div class="nd_options_container nd_options_clearfix">
            ...
            <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_text_align_center">
                <h1 class="nd_options_color_white nd_options_font_weight_normal nd_options_first_font">
                    <span class="nd_options_display_block">TERMS OF SERVICES</span>
            ...
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner vc_custom_1467360650255">
                    <div class="wpb_wrapper">
                        ...
                        <h1 style="color:; padding:px; text-align:center; font-size:40px; line-height:50px; letter-spacing: px; font-weight:normal;" class="  nd_options_text_align_center_responsive_important nd_options_first_font ">TERMS OF SERVICE AGREEMENT</h1>
                    </div>
                </div>
            </div>
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner vc_custom_1467207292391">
                    <div class="wpb_wrapper">
                        ...
                        <div class="wpb_text_column wpb_content_element  nd_options_text_align_center_responsive">
                            ...
                            <p><pre></pre>By using this Site You acknowledge and agree that:</p>
                            <p><pre></pre>
                                <ul>
                            ...
                            <p><pre></pre>You will not use this Site in a manner that:</p>
                            <p><pre></pre>
                                <ul>
                            ...
                            <p><pre></pre>You will not:</p>
                            <p><pre></pre>
                                <ul>
                                    <li>copy or distribute in any medium any part of this Site, except where expressly authorized by Company,</li>
                                    <li>copy or duplicate this Terms of Services agreement, which was created with the help of the TermsHub.io and the Terms and Conditions Generator,</li>
                            ...
                            <p><pre></pre>In addition to the general rules above, the provisions in this Section apply specifically to your use of Companies Content posted to Site. Companies Content on this Site, including without limitation the text, software, scripts, source code, API, graphics, photos, sounds, music, videos and interactive features and the trademarks, service marks and logos contained therein ("Companies Content"), are owned by or licensed to Halesi Travel Pvt. Ltd in perpetuity, and are subject to copyright, trademark, and/or patent protection.</p>
                            ...
                            <p><pre></pre>THE FOREGOING DISCLAIMER OF REPRESENTATIONS AND WARRANTIES SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW, and shall survive any termination or expiration of this Agreement or your use of this Site or the Services found at this Site.</p>
                            ...
                            <p><pre></pre>IN ADDITION, You SPECIFICALLY ACKNOWLEDGE AND agree that any cause of action arising out of or related to this Site or the Services found at this Site must be commenced within one (1) year after the cause of action accrues, otherwise such cause of action shall be permanently barred.</p>
                            <p><pre></pre>THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW, AND shall survive any termination or expiration of this Agreement or your use of this Site or the Services found at this Site.</p>
                            ...
                            <p><pre></pre>You acknowledge and agree that we have no control over the availability of this Site on a continuous or uninterrupted basis, and that we assume no liability to you or any other party with regard thereto.</p>

                            <pre></pre>
                            <h2>DISCONTINUED SERVICES</h2>
                            ...
                            <p><pre></pre>Nothing in this Agreement shall be deemed to confer any third-party rights or benefits.</p>
                            ...
                            <pre></pre>
                            <h2>GOVERNING LAW</h2>
                            <p><pre></pre>This Agreement and any dispute or claim arising out of or in connection with it or its subject matter or formation shall be governed by and construed in accordance with the laws of India, New Delhi, to the exclusion of conflict of law rules.</p>
                            
                            <pre></pre>
                            <h2>DISPUTE RESOLUTION</h2>
                            <p><pre></pre>Any controversy or claim arising out of or relating to these Terms of Services will be settled by binding arbitration. Any such controversy or claim must be arbitrated on an individual basis, and must not be consolidated in any arbitration with any claim or controversy of any other party. The arbitration must be conducted in India, New Delhi, and judgment on the arbitration award may be entered into any court having jurisdiction thereof.</p>

                            <pre></pre>
                            <h2>TITLES AND HEADINGS</h2>
                            <p><pre></pre>The titles and headings of this Agreement are for convenience and ease of reference only and shall not be utilized in any way to construe or interpret the agreement of the parties as otherwise set forth herein.</p>
                            ...
                            <p><pre></pre>If you have any questions about this Agreement, please contact us by email or regular mail at the following address:</p>
                            <p><pre></pre>Halesi Travel Pvt. Ltd<br />
                                9A/1, 4th Floor, Channa Market, WEA Karol Bagh, New Delhi-110005<br />
                                India<br />
                                halesitravel4u@gmail.com
                            </p>
                        </div>
                    </div>
                </div>
